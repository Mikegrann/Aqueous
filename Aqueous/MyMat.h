...
class MyMat {
	public:
		...
		glm::vec3 multVec(glm::vec3 input, bool isPoint);
		glm::vec3 multVecRight(glm::vec3 input, bool isPoint);
		...
		void makeTranslate(glm::vec3 trans);
		void makeRotate(glm::vec3 rotation);
		void makeScale(glm::vec3 scale);
