...
void MyMat::makeScale(glm::vec3 input)
{
...
void MyMat::makeTranslate(glm::vec3 input)
{
	m_Elem[0][0] = 1.0;
	m_Elem[0][1] = 0;
	m_Elem[0][2] = 0;
...
void MyMat::makeRotate(glm::vec3 input)
{
	MyMat x, y, z;
	glm::vec3 in;
...
glm::vec3 MyMat::multVec(glm::vec3 v, bool isPoint)
{
...
glm::vec3 MyMat::multVecRight(glm::vec3 v, bool isPoint)
{
	float hg = (isPoint ? 1.0 : 0.0);
	glm::vec3 newvec;
