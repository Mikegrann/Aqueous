...
void CMainState::CalculateDataAlignment()
{
	...
	SVector2d SplineMinOffset(CurrentSite->GetCurrentSplinePath()->GetXRange().Minimum, CurrentSite->GetCurrentSplinePath()->GetZRange().Minimum);
	SVector2d SplineMaxOffset(CurrentSite->GetCurrentSplinePath()->GetXRange().Maximum, CurrentSite->GetCurrentSplinePath()->GetZRange().Maximum);

	longlatd const SplineLonLatMin = Projection->OffsetFromStart(CurrentSite->GetCurrentSplinePath()->OffsetPos, SplineMinOffset);
	longlatd const SplineLonLatMax = Projection->OffsetFromStart(CurrentSite->GetCurrentSplinePath()->OffsetPos, SplineMaxOffset);
