...
void FrameSequence::dynamicAdvancement(map<glm::vec3, SharkVertex*, compareVect3> *sVertices, vector<Quad*> *quads )
{
	if(isDynamicMode)
	{
		...
		Keyframe * newQueueFrame = new Keyframe(shaderProg, sharkObject, sVertices, quads);
		//pointer problem?
